...
ARTIFACT_EXECUTIVE_BRIEF = "executive_brief"
ARTIFACT_TECHNICAL_BRIEF = "technical_brief"
ARTIFACT_PRODUCT_BRIEF = "product_brief"
...
ARTIFACTS_BY_STATE: dict[int, tuple[str, ...]] = {
    ...
    4: (
        ARTIFACT_REFLECTION, ARTIFACT_PITCH_ROOM,
        ARTIFACT_EXECUTIVE_BRIEF, ARTIFACT_TECHNICAL_BRIEF, ARTIFACT_PRODUCT_BRIEF,
    ),
    5: (
        ARTIFACT_REFLECTION, ARTIFACT_PITCH_ROOM, ARTIFACT_REVIEW_SUMMARY,
        ARTIFACT_EXECUTIVE_BRIEF, ARTIFACT_TECHNICAL_BRIEF, ARTIFACT_PRODUCT_BRIEF,
    ),
    6: (
        ARTIFACT_REFLECTION,

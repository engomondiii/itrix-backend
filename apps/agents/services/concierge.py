...
Full streaming + governance + conversation persistence arrive in Phase 3; the agent
contract here is stable so those layers slot in without changing callers.
"""
...
class ConciergeAgent(BaseAgent):
    ...
    def run_ai(self, ctx: AgentContext) -> AgentOutput:
        ...
        question = (ctx.extra or {}).get("message", "") or ctx.prompt

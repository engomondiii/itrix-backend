...
try:
    ...
    BEAT_SCHEDULE = {
    "recompute_health": {
        "task": "itrix.customer_success.recompute_health",
        "schedule": crontab(hour=2, minute=0),
    },  # nightly health recompute
    "sla_sweep": {
        "task": "itrix.customer_success.sla_sweep",
        "schedule": crontab(minute='*/15'),
    },  # SLA breach detection
    "build_change_digests": {
        "task": "itrix.customer_success.build_change_digests",
        "schedule": crontab(hour=3, minute=0),
    },  # nightly digest refresh
    }
